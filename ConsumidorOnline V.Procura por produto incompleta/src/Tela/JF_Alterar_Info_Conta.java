...
public class JF_Alterar_Info_Conta extends javax.swing.JFrame {
    ...
    public JF_Alterar_Info_Conta(String nome, String login, String senha, String email, int id) {
        ...
        JTF_NomeUsu_Usu2.setText(this.nome);
        JTF_Login_Cria_Usu.setText(this.login);
        JTF_Cria_Email.setText(this.email);
        JTF_Cria_Email_Confirma.setText(this.email);
        JTF_Senha_Cria.setText(this.senha);
        JTF_Cria_Senha_Confirma.setText(this.senha);
    }
