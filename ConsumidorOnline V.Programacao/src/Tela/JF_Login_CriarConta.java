...
public class JF_Login_CriarConta extends javax.swing.JFrame {
    ...
    public void infoCliente(String login, String senha) {
        try {
    ...
    private void setIcon() {
        setIconImage(Toolkit.getDefaultToolkit().getImage(getClass().getResource("D:\\Curso\\Java\\CadastroBancoDeDadosV02_1\\ConsumidorOnline\\src\\IMG\\IconeCO.jpg")));
    }
    ...
    private void JB_Entra_LoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JB_Entra_LoginActionPerformed
        ...
        String senha = JTF_Senha_Usu.getText();
    ...
    private void JB_Criar_ContaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_JB_Criar_ContaMouseClicked
        ...
        String senha = JTF_Senha_Cria.getText();
        String confirmaSenha = JTF_Cria_Senha_Confirma.getText();
        //  JOptionPane.showMessageDialog(null,""+nome+" "+login+" "+email+" "+" "+senha);
