...
public class JF_Tela_Principal extends javax.swing.JFrame {
    ...
    public void procuraItemAut(int id, String email) {
        ...
        try {
            ...
            email = clid.recolheinfo(this.id).getEmail();
            ItemPesquisaDAO ipd = new ItemPesquisaDAO();
            ...
            Logger.getLogger(JF_Tela_Principal.class.getName()).log(Level.SEVERE, null, aiobe);
        }
        jLB_MostraOQueTaAconteceod.setText("");
...
//colocando todos os campos em null
    ...
    private void JBTN_Salvar_SelecionadoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JBTN_Salvar_SelecionadoActionPerformed
        ...
        if (opcao == 0) {
            ...
            if (checkexiste == false) {
                JOptionPane.showMessageDialog(null, "Nenhum campo de tag preenchido", "Erro", JOptionPane.ERROR_MESSAGE);
            } else {
                if (JTF_Nome_Pesquisa_selecionado.getText().isEmpty()) {
                    JOptionPane.showMessageDialog(null, "Nome de pesquisa obrigatório", "Erro", JOptionPane.ERROR_MESSAGE);
                } else {
                    try {
                        TagDAO tagd;
                        ...
                        if (JTF_tag1_selecionado.getText().isEmpty()) {
                            if (!(this.nomeCamposESelecionado[0].isEmpty())) {

                                ptd.deletaTag(this.id_Pesquisa, tagd.recolherInfo(nomeCamposESelecionado[0]).getId());
                            }
                        } else {
                            for (int i = 0; i < tags.length; i++) {
                                if (tags[i].equals("")) {
                        ...
                        if (JTF_tag2_selecionado.getText().isEmpty()) {
                            if (!(this.nomeCamposESelecionado[1].isEmpty())) {

                                ptd.deletaTag(this.id_Pesquisa, tagd.recolherInfo(nomeCamposESelecionado[1]).getId());
                            }
                        } else {
                            for (int i = 0; i < tags.length; i++) {
                                if (tags[i].equals("")) {
                        ...
                        if (JTF_tag3_selecionado.getText().isEmpty()) {
                            if (!(this.nomeCamposESelecionado[2].isEmpty())) {

                                ptd.deletaTag(this.id_Pesquisa, tagd.recolherInfo(nomeCamposESelecionado[2]).getId());
                            }
                        } else {
                            for (int i = 0; i < tags.length; i++) {
                                if (tags[i].equals("")) {
                        ...
                        if (JTF_tag4_selecionado.getText().isEmpty()) {
                            if (!(this.nomeCamposESelecionado[3].isEmpty())) {

                                ptd.deletaTag(this.id_Pesquisa, tagd.recolherInfo(nomeCamposESelecionado[3]).getId());
                            }
                        } else {
                            for (int i = 0; i < tags.length; i++) {
                                if (tags[i].equals("")) {
                        ...
                        if (JTF_tag5_selecionado.getText().isEmpty()) {
                            if (!(this.nomeCamposESelecionado[4].isEmpty())) {

                                ptd.deletaTag(this.id_Pesquisa, tagd.recolherInfo(nomeCamposESelecionado[4]).getId());
                            }
                        } else {
                            for (int i = 0; i < tags.length; i++) {
                                if (tags[i].equals("")) {
                        ...
                        if (JTF_tag_Preco_maximo_selecionado.getText().isEmpty()) {
                            JTF_tag_Preco_maximo_selecionado.setText("0");
                        }
