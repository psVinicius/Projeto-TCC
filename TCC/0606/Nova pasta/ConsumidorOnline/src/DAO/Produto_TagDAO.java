...
public class Produto_TagDAO {
    ...
    public boolean acharProduto(int tag1, int tag2, int tag3, int tag4, int tag5, int numTag) {
        int i = -1;
        ...
        try {
            ...
            while (rs.next()) {
                ...
                this.idprod[i] = pt.getId_produto();
                System.out.println("this.idprod "+this.idprod[i]);
