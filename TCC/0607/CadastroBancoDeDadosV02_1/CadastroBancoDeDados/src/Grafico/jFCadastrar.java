...
public class jFCadastrar extends javax.swing.JFrame {
    ...
    public jFCadastrar() {
        ...
        ImageIcon img = new ImageIcon(jFCadastrar.class.getResource("/IMG/img.jpg"));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jFCadastrar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new jFCadastrar().setVisible(true);
            }
        });
    }
