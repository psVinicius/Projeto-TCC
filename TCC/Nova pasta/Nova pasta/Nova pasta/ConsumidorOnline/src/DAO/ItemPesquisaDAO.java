...
//adiciona um novo item de pesquisa
    ...
    public void adiciona(int id, String nome, float preco, boolean status) {
        String sql = "insert into itempesquisa (id_cliente, nome_pesquisa, preco, status) values (?,?,?,?)";
...
// recolhe id e preco do item de pesquisa com base que vc ja tenha o nome da mesma e sua id
    public ItemPesquisa recolherInfo(int ide, String nomeP) {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                ip.setStatus(rs.getBoolean("status"));
                return ip;
    ...
    public ArrayList<ItemPesquisa> listaItensPausados(int idcliente) {
        PreparedStatement stmt = null;
        ResultSet rs = null;
        ...
        try {
            ...
            stmt = con.prepareStatement("select * \n"
                    + "from itemPesquisa \n"
                    + "where itempesquisa.id_cliente = ? and itemPesquisa.status = false");
...
//lista de items pesquisados, isso eu usei, me lembro O.O
    ...
    public List<ItemPesquisa> listaItensPesquisados(int id) {
        ...
        ArrayList<ItemPesquisa> itemPesquisa = new ArrayList<ItemPesquisa>();
        ItemPesquisa ip = new ItemPesquisa();
        try {
            PreparedStatement stmt = null;
            ResultSet rs = null;
